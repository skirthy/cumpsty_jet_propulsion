...
bypassRatio           = 10;        # Engine bypass ratio
...
fileNameStrMat      = strcat('enginePropValues_bpr_',num2str(engine.bypRatio),'.mat');
save(fileNameStrMat,'engine','staticProp','stagProp','gasProp');

##fid1 = fopen('engine_performance_vs_bypass_ratio.dat','a');
##fprintf(fid1,'%f\t%f\t%f\t%f\t%f\t%f\t%f\n',bypRatio,velCoreJet,temp013,temp09,tempDiff045to05,presRatio045to05,bypassPresRatio);
##fclose(fid1);
