...
# A GIVEN STATION FROM THE STAGNATION PRESSURE RATIO
# ------------------------------------------------------------------------------
# Author: Srinivas Kirthy K.
# Date: 01/03/2026
# ==============================================================================

function [stagPropVals] = stagPropFromPresRatio(stagPropVals,engineVals,gasPropVals,stationNumVal)
  ...
  presRatioVal          = getfield(stagPropVals,presRatioStr);

  # Calculate temperature ratio from pressure ratio
  tempRatioVal          = tempRatioFromPresRatio(presRatioVal,effComponentVal,gammaVal);

  # Calulate stagnation pressure and temperature at the present station
  presStationVal        = presPrevStationVal*presRatioVal;
  tempStationVal        = tempPrevStationVal*tempRatioVal;
  ...
  stagPropVals          = setfield(stagPropVals,tempStationStr,tempStationVal);
